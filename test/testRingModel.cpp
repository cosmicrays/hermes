...
protected:
	...
	neutralgas::RingModel ringModel_HI = neutralgas::RingModel(neutralgas::RingType::HI);
};
...
TEST_F(RingModel, RingValues) {
  	neutralgas::RingModel ringModel_CO = neutralgas::RingModel(neutralgas::RingType::CO);
