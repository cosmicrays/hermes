...
TEST(SynchroAbsorptionIntegrator, integrateOverLOS) {
	...
	// EXPECT_NEAR(static_cast<double>(T_S), static_cast<double>(T_A),
	// 1e-5); //
	// K
	...
	// EXPECT_NEAR(static_cast<double>(T_A)/static_cast<double>(T_S), 0.79,
	// 0.01);
	...
	// EXPECT_NEAR(static_cast<double>(T_A)/static_cast<double>(T_S), 0.017,
	// 0.001);
}
