...
TEST(Interactions, KelnerAharonianSigmaInelastic) {
	...
	auto sigma =
	    interactions::KelnerAharonianGamma::sigmaInelastic(E_proton);
...
TEST(Interactions, KelnerAharonianVsKamae06Gamma) {
	...
	EXPECT_NEAR(static_cast<double>(
			kamae06->getDiffCrossSection(E_proton, E_gamma)),
		    static_cast<double>(
			kelahar->getDiffCrossSection(E_proton, E_gamma)),
...
TEST(Interactions, KelnerAharonianVsKamae06Neutrino) {
	...
	EXPECT_NEAR(static_cast<double>(
			kamae06->getDiffCrossSection(E_proton, E_neutrino)),
		    static_cast<double>(
			kelahar->getDiffCrossSection(E_proton, E_neutrino)),
		    static_cast<double>(5e-21));
