...
void init(py::module &m) {
    ...
    py::class_<MagneticField, std::shared_ptr<MagneticField>>(subm, "MagneticField")
	      .def("getField", &MagneticField::getField);
    
    py::class_<Sun08Field, std::shared_ptr<Sun08Field>, MagneticField>(subm, "Sun08Field")
	      .def(py::init<>())
	      .def("getField", &MagneticField::getField);

    py::class_<PT11Field, std::shared_ptr<PT11Field>, MagneticField>(subm, "PT11Field")
	      .def(py::init<>())
	      .def("getField", &MagneticField::getField);

    py::class_<JF12Field, std::shared_ptr<JF12Field>, MagneticField>(subm, "JF12Field")
	      .def(py::init<>())
	      .def("getField", &MagneticField::getField);
}
