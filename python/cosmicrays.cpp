...
void init(py::module &m) {
    ...
    py::class_<DummyCRDensity, std::shared_ptr<DummyCRDensity>, CosmicRayDensity>(subm, "DummyCRDensity")
	      .def(py::init<>())
	      .def(py::init<const PID &, const QEnergy &, const QEnergy &, int>(),
				py::arg("PID"), py::arg("E_min"), py::arg("E_max"), py::arg("steps"));
    py::class_<SimpleCRDensity, std::shared_ptr<SimpleCRDensity>, CosmicRayDensity>(subm, "SimpleCRDensity")
	      .def(py::init<>())
	      .def(py::init<const PID &, const QEnergy &, const QEnergy &, int>(),
				py::arg("PID"), py::arg("E_min"), py::arg("E_max"), py::arg("steps"));
    py::class_<Sun08CRDensity, std::shared_ptr<Sun08CRDensity>, CosmicRayDensity>(subm, "Sun08CRDensity")
	      .def(py::init<>());
