...
void declare_quantity(py::module &m, std::string const &typestr,
	...
	.def(
	    "__lt__",
	    [](const Q &self, const Q &other) -> bool { return self < other; },
	    py::is_operator())
	.def(
	    "__le__",
	    [](const Q &self, const Q &other) -> bool { return self <= other; },
	...
	.def(
	    ...
	    py::is_operator())
	.def(
	    "__mul__", [](const Q &self, const int a) -> Q { return a * self; },
	    py::is_operator())
	.def(
	    "__mul__",
	...
	.def("toAstroPy", [apyu, suffix](const Q &q) {
	    ...
	    throw std::runtime_error("Error: cannot use .toApy() without "
...
void init_quantity(py::module &m) {
	...
	std::cerr << "No astropy.units package found. For advanced units "
