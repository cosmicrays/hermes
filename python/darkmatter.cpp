...
void init(py::module &m) {
	...
	py::class_<DarkMatterSpectrum, std::shared_ptr<DarkMatterSpectrum>>(
		...
		.def("getParticlesPerEnergy", &DarkMatterSpectrum::getParticlesPerEnergy);
	py::class_<PPPC4DMIDSpectrum, std::shared_ptr<PPPC4DMIDSpectrum>, DarkMatterSpectrum>(
	    subm, "PPPC4DMIDSpectrum")
	    .def(py::init<Channel, Mass>())
	    .def("getRestMassEnergy", &PPPC4DMIDSpectrum::getRestMassEnergy)
	    .def("getParticlesPerEnergy", &PPPC4DMIDSpectrum::getParticlesPerEnergy);
}
