...
void init(py::module &m) {
	...
	py::class_<ChargedGasDensity, std::shared_ptr<ChargedGasDensity>>(
	    subm, "ChargedGasDensity")
	    .def("getDensity", &ChargedGasDensity::getDensity);
	py::class_<HII_Cordes91, std::shared_ptr<HII_Cordes91>,
		   ChargedGasDensity>(subm, "HII_Cordes91")
	    .def(py::init<>())
	    .def("getDensity", &ChargedGasDensity::getDensity);
	py::class_<NE2001Simple, std::shared_ptr<NE2001Simple>,
		   ChargedGasDensity>(subm, "NE2001Simple")
	    .def(py::init<>())
	    .def("getDensity", &ChargedGasDensity::getDensity);
	py::class_<YMW16, std::shared_ptr<YMW16>, ChargedGasDensity>(subm,
								     "YMW16")
	    .def(py::init<>())
	    .def("getDensity",
