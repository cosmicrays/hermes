...
LITERAL(QEnergy, _keV, kiloelectronvolt)
LITERAL(QEnergy, _MeV, megaelectronvolt)
LITERAL(QEnergy, _GeV, gigaelectronvolt)
LITERAL(QEnergy, _TeV, teraelectronvolt)
LITERAL(QEnergy, _PeV, petaelectronvolt)
LITERAL(QEnergy, _EeV, exaelectronvolt)
