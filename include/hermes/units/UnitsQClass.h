...
template <typename LengthDim, typename TimeDim, typename MassDim,
          typename ECurrentDim, typename TemperatureDim, typename SubstanceDim,
          typename LIntensityDim, typename AngleDim, typename SolidAngleDim>
class Quantity {
  private:
	double value;
...
constexpr std::ostream &operator<<(
    std::ostream &lhs, const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator+(
    const Quantity<l, t, m, I, T, N, J, A, SA> &lhs,
    const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
	return Quantity<l, t, m, I, T, N, J, A, SA>(static_cast<double>(lhs) +
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator*(
    const double &lhs, const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
...
operator/(const Quantity<l1, t1, m1, I1, T1, N1, J1, A1, SA1> &lhs,
	...
	return Quantity<std::ratio_subtract<l1, l2>, std::ratio_subtract<t1, t2>,
	                ...
	                std::ratio_subtract<T1, T2>, std::ratio_subtract<N1, N2>,
	                std::ratio_subtract<J1, J2>, std::ratio_subtract<A1, A2>,
	                std::ratio_subtract<SA1, SA2>>(static_cast<double>(lhs) /
	                                               static_cast<double>(rhs));
}
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<std::ratio_subtract<std::ratio<0>, l>,
...
operator/(double x, const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
	return Quantity<std::ratio_subtract<std::ratio<0>, l>,
	                std::ratio_subtract<std::ratio<0>, t>,
	                std::ratio_subtract<std::ratio<0>, m>,
	                std::ratio_subtract<std::ratio<0>, I>,
	                std::ratio_subtract<std::ratio<0>, T>,
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> fabs(
    const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> floor(
    const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
	return Quantity<l, t, m, I, T, N, J, A, SA>(
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> round(
    const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
	return Quantity<l, t, m, I, T, N, J, A, SA>(
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> fmod(
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<
    std::ratio_divide<l, std::ratio<2>>, std::ratio_divide<t, std::ratio<2>>,
...
sqrt(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
	return Quantity<std::ratio_divide<l, std::ratio<2>>,
...
inline double sqrt(double num) { return std::sqrt(num); }

// pow()
template <int exponent, typename l, typename t, typename m, typename I,
          typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<std::ratio_multiply<l, std::ratio<exponent>>,
                   std::ratio_multiply<t, std::ratio<exponent>>,
                   std::ratio_multiply<m, std::ratio<exponent>>,
                   std::ratio_multiply<I, std::ratio<exponent>>,
                   std::ratio_multiply<T, std::ratio<exponent>>,
                   std::ratio_multiply<N, std::ratio<exponent>>,
                   std::ratio_multiply<J, std::ratio<exponent>>,
                   std::ratio_multiply<A, std::ratio<exponent>>,
                   std::ratio_multiply<SA, std::ratio<exponent>>>
pow(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
	return Quantity<std::ratio_multiply<l, std::ratio<exponent>>,
	                std::ratio_multiply<t, std::ratio<exponent>>,
	                std::ratio_multiply<m, std::ratio<exponent>>,
	                std::ratio_multiply<I, std::ratio<exponent>>,
	                std::ratio_multiply<T, std::ratio<exponent>>,
...
template <typename l, typename t, typename m, typename I, typename T,
          typename N, typename J, typename A, typename SA>
constexpr Quantity<std::ratio_multiply<l, std::ratio<2>>,
                   std::ratio_multiply<t, std::ratio<2>>,
                   std::ratio_multiply<m, std::ratio<2>>,
                   std::ratio_multiply<I, std::ratio<2>>,
                   std::ratio_multiply<T, std::ratio<2>>,
...
squared(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
	return Quantity<std::ratio_multiply<l, std::ratio<2>>,
	                std::ratio_multiply<t, std::ratio<2>>,
	                std::ratio_multiply<m, std::ratio<2>>,
	                std::ratio_multiply<I, std::ratio<2>>,
	                std::ratio_multiply<T, std::ratio<2>>,
...
#define QUANTITY_TYPE(_ldim, _tdim, _mdim, _Idim, _Tdim, _Ndim, _Jdim, _Adim,  \
                      _SAdim, name)                                            \
	typedef Quantity<std::ratio<_ldim>, std::ratio<_tdim>, std::ratio<_mdim>,  \
	                 std::ratio<_Idim>, std::ratio<_Tdim>, std::ratio<_Ndim>,  \
	                 std::ratio<_Jdim>, std::ratio<_Adim>, std::ratio<_SAdim>> \
	    name;                                                                  \
	typedef Quantity<std::ratio_multiply<std::ratio<_ldim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_tdim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_mdim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_Idim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_Tdim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_Ndim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_Jdim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_Adim>, std::ratio<2>>,    \
	                 std::ratio_multiply<std::ratio<_SAdim>, std::ratio<2>>>   \
	    name##Squared;
